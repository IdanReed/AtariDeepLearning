#!/usr/bin/env python3
"""
Freeze Transformer experiment for vast.ai deployment.

Usage:
    python vast_experiment_freeze_transformer.py --dataset-root /workspace/dataset
"""
...
def main():
    args, data = setup_experiment(
        ...
        description="Run Freeze Transformer experiment",
    )
    ...
    run_experiment_freeze(
        ...
        experiment_dir=args.output_dir / "freeze_transformer",
        best_params=BEST_BASELINE_PARAMS,
    )

    print("Experiment freeze_transformer completed!")
